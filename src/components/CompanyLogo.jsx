...
import ekata from "../assets/ekata.png";
import maupergi from "../assets/maupergi4.png";

const CompanyLogo = () => {
  const logos = [maupergi, ekata];
      ...
      <div className="flex animate-marquee whitespace-nowrap">
        {logos.map((logo, index) => (
          <img
            ...
            className="mx-12 h-10 w-36 object-contain grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all"
          />
        ))}
