    ...
    >
      <div className="flex flex-col md:flex-row items-center gap-12">
        ...
        <motion.div variants={fadeIn("right", 0.3)} className="w-full md:w-1/2">
          ...
          >
            PEDEDIGITAL bukan sekadar platform digital - ini adalah tempat kamu
            bertumbuh bareng komunitas yang aktif, saling bantu, diskusi, dan
            mentoring. Semua member dapat akses seumur hidup plus support penuh
            dari tim dan sesama pengguna.
          </motion.p>
          {/* <motion.a
